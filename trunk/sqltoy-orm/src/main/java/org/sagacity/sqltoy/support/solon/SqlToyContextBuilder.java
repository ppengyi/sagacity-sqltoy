...
import org.sagacity.sqltoy.support.solon.configure.Elastic;
import org.sagacity.sqltoy.support.solon.configure.ElasticConfig;
import org.sagacity.sqltoy.support.solon.configure.SqlToyContextProperties;
import org.sagacity.sqltoy.support.solon.impl.SolonAppContext;
import org.sagacity.sqltoy.support.solon.impl.SolonConnectionFactory;
...
public class SqlToyContextBuilder {
    ...
    public SqlToyContextBuilder(SqlToyContextProperties properties, org.noear.solon.core.AppContext context) {
    ...
    public SqlToyContext build() throws Exception {
        ...
        if (StringUtil.isNotBlank(unfiyHandler)) {
            ...
            sqlToyContext.setUnifyFieldsHandler(new IUnifyFieldsHandler() {
            });
        }
        ...
        // sqlToyContext.setTaskExecutor(
        //         Executors.newThreadPerTaskExecutor(
        //                 Thread.ofVirtual().name("sqlToy-", 0).factory()
        //         )
        // );
